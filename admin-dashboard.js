...
function loadOrdersByDate(date) {
  ...
  fetch(`https://script.google.com/macros/s/AKfycbzFkFkHIwX8ndh6epO1S3DtmbqFXUFntP6l0jQJ4OZ0515yp0Yj55aARMYN1T7lgb4w/exec?action=getOrdersByDate&date=${selectedDate}`)
...
function fetchDeliveryUsers(orderId) {
  fetch('https://script.google.com/macros/s/AKfycbzFkFkHIwX8ndh6epO1S3DtmbqFXUFntP6l0jQJ4OZ0515yp0Yj55aARMYN1T7lgb4w/exec?action=getDeliveryUsers')
    .then(response => response.json())
    .then(data => {
      if (data.success) {
